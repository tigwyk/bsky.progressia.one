  ...
  return (
    <Dialog.Outer control={control} onClose={onClose}>
      ...
      <Dialog.ScrollableInner
        label={_(msg`Announcing verification on ProgressiaOne`)}
        style={[
        ...
        <View style={[a.align_start, a.gap_xl]}>
          ...
          <View style={[a.gap_xs]}>
            ...
            <Text style={[a.leading_snug, a.text_md]}>
              <Trans>
                We’re introducing a new layer of verification on ProgressiaOne —
          ...
          <View
            ...
            <Image
              ...
              alt={_(
                msg`An mockup of a iPhone showing the ProgressiaOne app open to the profile of a verified user with a blue checkmark next to their display name.`,
              )}
            />
          </View>
          ...
          <View style={[a.gap_sm]}>
            ...
            <View style={[a.gap_sm]}>
              <Text style={[a.leading_snug, a.text_md]}>
                <Trans>
                  ProgressiaOne will proactively verify notable and authentic
                  accounts.
                </Trans>
              </Text>
              <Text style={[a.leading_snug, a.text_md]}>
